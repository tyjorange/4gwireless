...
<!-- start: Header -->
					...
					<div class="box span12">
						...
						<div align="center">
							<table style="min-width: 20%;">
								<tr>
									<th>描述 ：</th>
									<td><input style="margin-bottom: 0px;width: 706px;" id="desc" type="text" /></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
								<tr>
									<th>备注：</th>
									<td><textarea style="margin-bottom: 0px;width: 706px;height: 100px;resize: none;" id="comment"></textarea></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
	...
	<script src="js/equi_info.js"></script>
